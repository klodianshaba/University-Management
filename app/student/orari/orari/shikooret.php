...
<body>
    ...
    <div class="right-container">
        <div>
           <div class="title-bar" style="width:100%; height: 33px;"><div id="" style="padding-top: 10px;">Shiko Oraret</div></div>
...
?>
    ...
    <form action="" method="post">
        <div class="dep" style="display: inline;">
            <select name="dep" id="dep" class="drp" style="width:20%;">
        ...
        <div class="dega" style="display: inline;">
            <select name="dega" id="dega" class="drp" style="width:20%;">
                <option value="">Selekto Degen </option>
            </select>
        </div>

        <div class="viti" style="display: inline;">
            <select name="viti" id="viti" class="drp" style="width:20%;">
        ...
        <div class="Grupi" style="display: inline;">
            <select name="grupi" id="grupi" class="drp" style="width:20%;">
