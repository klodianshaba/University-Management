...
<body>
    ...
    <div class="right-container">
            ...
            <div class="title-bar" style="width:100%; height: 33px;"><div id="" style="padding-top: 10px;">Deget</div></div>
...
include ("objekti_sql.php");
    ...
    <form action="" method="post">
        <div class="dep" style="display: inline;padding:10px;">
         
            <select class="selectdrop" name="dep" id="dep">
    ...
    if(isset($_POST['kot'])){
        ...
        if(!empty($dep)  ){
            ...
            echo '<br><div id="perqef"  style="margin-left:10px; color:black;margin-top:5px;"> Selektoni Departamentin  qe te Shfaqet tabela per regjistrim Degesh!!</div>';
        }
...
<div class="containe" style="color:black;padding:10px;text-align:center;" >
          <caption style="color:black !important;margin:10px; ">
			...
			<?php 
				...
				echo "Ju jeni duke Shikuar Deget tek Departamenti : ".$EmriDepartamentin.""
			?>
		</caption><br><br>
