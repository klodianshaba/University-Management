...
<head>
    ...
    <script>
        ...
        var columns = new Array("Emri","Mbiemri","Email","nrtel","Grupi");
        var placeholder = new Array("Emri","Mbiemri","Email","nrtel","Grupi p.sh. A");
...
<body>
    ...
    <div class="right-container">
        ...
        <div>
            <div class="title-bar" style="width:100%; height: 33px;"><div id="" style="padding-top: 10px;">Studentet | Shto Studente</div>
				<input type="search" class="light-table-filter" id="search" data-table="order-table" placeholder="Kerko Studente"  style="  width:300px;height: 23px;background-color:#fff;color:#000;float:right;margin-top:-25px;border:none;padding:5px">
			</div>
...
<?php
    ...
    <form action="" method="post">
        <div class="dep" style="display: inline;">
            <select name="dep" id="dep" style="color:#fff;">
    ...
    if(isset($_POST['kot'])){
        ...
        if(!empty($dep)  && !empty($dega)){
            ...
            echo '<div id="perqef"  style="margin-left:0px; margin-top:5px;"> Selektoni Departamentin dhe Degen qe te Shfaqet tabela per regjistrim studentesh!!</div>';
        }
...
<div class="containe">
        ...
        <?php $em_dega = mysql_query("select Emri from deget where Dg_id = ".$dega);
            ...
            echo "Ju jeni duke shtuar student tek Departamenti : ".$EmriDepartamentin.",Dega : ".$EmriDeges;?></caption><br><br>
               ...
               <th>ID</th>
                ...
                ?>
                    ...
                    <tr id="<?=$eachRecord['ID'];?>">
                        ...
                        <td class="Grupi"><?=$eachRecord['Grupi'];?></td>
                        <td>
...
<script type="text/javascript">
    (function(document) {
     ...
     <?php } ?>
<div id="error" style="display:none;position:absolute;width:200px;height:40px;background: #6D5894;color:white;text-align:center;vertical-align:middle;line-height:40px;border-radius:30px"></div>
