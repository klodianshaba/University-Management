...
<head>
    ...
    <script>
        ...
        var columns = new Array("Emri","Mbiemri","Email","nrtel");
        var placeholder = new Array("Emri","Mbiemri","Email","nrtel");
...
<body>
    ...
    <div class="right-container">
        ...
        <div>
            <div class="title-bar" style="width:100%; height: 33px;"><div id="" style="padding-top: 10px;">Profesoret | Shto Profesore</div>
			<input type="search" class="light-table-filter" id="search" data-table="order-table" placeholder="Kerko Profesore"  style="  width:300px;height: 23px;background-color:#fff;color:#000;float:right;margin-top:-25px;border:none;padding:5px">
			</div>
...
<?php
    ...
    <form action="" method="post">
        <div class="dep" style="display: inline;">
            <select name="dep" id="dep" style="margin-left: 0px;  color:#fff;">
        ...
        <div class="ren" style="display: inline;">
            <input type="submit" value="Afisho Tabelen" d="butoni" name="kot" class="result-btn"> 
    ...
    if(isset($_POST['kot'])){
        ...
        if(!empty($dep)  && !empty($dega)){
            ...
            echo '<div id="perqef"  style="margin-left:0px; margin-top:5px;"> Selektoni Departamentin dhe Degen qe te Shfaqet tabela per regjistrim Profesoresh!!</div>';
        }
...
<div class="containe" >
 ...
 <caption style="text-align:center;color:black">
        ...
        <?php $em_dega = mysql_query("select Emri from deget where Dg_id = ".$dega);
            ...
            echo "Ju jeni duke shtuar Profesor tek Departamenti : ".$EmriDepartamentin.",Dega : ".$EmriDeges;?></caption><br><br>
<div id ="scroll" style="overflow: auto; height: 490px;">
           ...
           <th>ID</th>
            ...
            <th>ACTION</th>
                ...
                ?>
                    ...
                    <tr id="<?=$eachRecord['P_id'];?>">
                        <td><?=$eachRecord['P_id'];?></td>
                        ...
                        <td>
                            <a href="javascript:;" id="<?=$eachRecord['P_id'];?>" class="ajaxEdit"><img src="" class="eimage"> <span class="glyphicon glyphicon-pencil"></span></a>
                            <a href="javascript:;" id="<?=$eachRecord['P_id'];?>" class="ajaxDelete"><img src="" class="dimage">  <span class="glyphicon glyphicon-trash"></span></a>
                        </td>
                    </tr>
                <?php } }?>
    </table>
