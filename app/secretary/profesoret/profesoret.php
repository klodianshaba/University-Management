...
<body>
    ...
    <div class="right-container">
        <div class="shto-njoftim" id="Njoftim" style="background-color:#ebf1f5 ;">
            <div class="title-bar" style="width:100%; height: 33px;"><div id="" style="padding-top: 10px;">Profesoret</div></div>
...
include ("objekti_sql.php");
    ...
    <form action="" method="post">
        <div class="dep" style="display: inline;margin-left: 10px;">
    ...
    if(isset($_POST['kot'])){
        ...
        if(!empty($dep)  && !empty($dega)){
            ...
            echo '<div id="perqef"  style="margin-left:10px; margin-top:5px;"> Selektoni Departamentin dhe Degen qe te Shfaqet tabela per te shikuar Profesoret!!</div>';
        }
...
<div class="containe" style="margin:10px">
        ...
        <?php $em_dega = mysql_query("select Emri from deget where Dg_id = ".$dega);
            ...
            echo "Ju jeni duke Shikuar Profesor tek Departamenti : ".$EmriDepartamentin.",Dega : ".$EmriDeges;?></caption><br><br>
 ...
 <div style="height:470px;overflow: auto;"> 
    ...
    <table border="0" class=" table table-striped table-hover table-bordered table-condensed tableDemo bordered order-table table"  style="margin-top:-5px;">
        ...
        <tr id="header">
           ...
           <?php
              $sql= $db->query("SELECT * from profesoret where D_id='$dep' and Dg_id='$dega' " );
