...
<head>
    ...
    <script>
        ...
        var columns = new Array("Emri","Prog_studimi","Vitet");
        var placeholder = new Array("Emri_Deges","Prog_studimi","Vitet");
...
<body>
    ...
    <div class="right-container">
        ...
        <div>
            <div class="title-bar" style="width:100%; height: 33px;"><div id="" style="padding-top: 10px;">Deget | Shto Dege</div>
			<input type="search" class="light-table-filter" id="search" data-table="order-table" placeholder="Kerko Dege"  style="  width:300px;height: 23px;background-color:#fff;color:#000;float:right;margin-top:-25px;border:none;padding:5px">
			</div>
    ...
    <form action="" method="post">
        ...
        <div class="ren" style="display: inline;">
            <input type="submit" value="Afisho Tabelen" id="butoni" name="afishotabelen" class="result-btn"> 
    ...
    <!-- Shfaqim  tabelen mbas selektimin e suksesshem te dropdown -->
					...
					if(isset($_POST['afishotabelen'])){
						...
						if(!empty($dep)  ){
							...
							echo '<div id="perqef"  style="margin-left:0px; margin-top:5px;"> Selektoni Departamentin  qe te Shfaqet tabela per regjistrim Degesh!!</div>';
						}
...
<caption style="text-align:center;color:black">
        ...
        <?php 
            ...
            echo "Ju jeni duke shtuar Dege tek Departamenti : ".$EmriDepartamentin.""?></caption><br><br>
<div id="height" style="overflow: auto;height: 470px;">
    <table border="0" class=" table table-striped table-hover table-bordered table-condensed tableDemo bordered order-table table"  style="margin-top:-5px; border-bottom:2 px solid; ">
           ...
           <th>ID</th>
            ...
            <th>ACTION</th>
                ...
                ?>
                    ...
                    <tr id="<?=$eachRecord['Dg_id'];?>">
                        <td><?=$eachRecord['Dg_id'];?></td>
                        <td class="Emri"><?=$eachRecord['Emri'];?></td>
                        <td class="Prog_studimi"><?=$eachRecord['Prog_studimi'];?></td>
                        <td class="Vitet"><?=$eachRecord['vitet'];?></td>
                    
                        <td>
                            <a href="javascript:;" id="<?=$eachRecord['Dg_id'];?>" class="ajaxEdit"><img src="" class="eimage"> <span class="glyphicon glyphicon-pencil"></span></a>
                            <a href="javascript:;" id="<?=$eachRecord['Dg_id'];?>" class="ajaxDelete"><img src="" class="dimage">  <span class="glyphicon glyphicon-trash"></span></a>
                        </td>
                    </tr>
                <?php } }?>
    </table>
