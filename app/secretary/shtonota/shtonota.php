<?php 
  ...
  if(isset($_SESSION['Sktrloguar']) && $_SESSION['Sktrloguar'] == false) {
      ...
      window.location="../../../../uni/Login form 2/sekretarja/index.php"; </script> ';
  }
 ?>
...
<div style="height:460px;overflow: auto;border-bottom: 2px solid;">
  <form action="shtonota.php" method="post" >
     <table border="0" class=" table table-striped table-hover table-bordered table-condensed tableDemo bordered order-table table"  style="margin-top:-5px; font-size: 14px;">
   ...
   <input type="submit" name="saveall" style="width:99%; background-color: #354052; color:white; border:none; height: 25px;" value="Save All">
   </div>
</form>
...
if(isset($_POST['saveall'])){
    ...
    $panota=-1;
    echo'<script>alert("Notat u rifreskuan me sukses!")</script>';
    for ($i=0; $i<=$count; $i++){
