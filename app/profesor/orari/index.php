...
<body>
            ...
            <ul>
                ...
                <li class="tabs"><a href="#">Njoftime</a> <span class="plus" id="plus8">+</span>
                    <ul class="submenu" value="none" id="sub3">
                        ...
                        <li><a href="../njoftimet/shtonjoftim/shtonjoftim.php"><img src="../img/sign.png" class="circle-icon-sm" id="" >Shto Njoftim</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="right-container">
        <div>
           <div class="title-bar" style="width:100%; height: 33px;margin-top: -3.5%;"><div id="" style="padding-top: 10px;">Shiko Oraret</div></div>
