...
<head>
	<title></title>
	<link rel="stylesheet" type="text/css" href="studentOrari.css">
...
<body>
 ...
 <h3>"Shikoni orarin ,Selektoni departamentin selektoni degen selektoni vitin selektoni grupi  dhe kliko shikoni orarin" kupton lando  </h3>
    ...
    <form action="" method="post">
        <div class="dep" style="display: inline;">
            <select name="dep" id="dep" class="drp">
                <option value="">Selekto Departamentin</option>
                <?php
                if($rowCount > 0){
                    while($row = $query->fetch_assoc()){ 
                        echo '<option value="'.$row["D_id"].'">'.$row['Emri'].'</option>';              
                    }
                }else{
        ...
        <div class="dega" style="display: inline;">
            <select name="dega" id="dega" class="drp">
                <option value="">Selekto Degen </option>
            </select>
        </div>

        <div class="viti" style="display: inline;">
            <select name="viti" id="viti" class="drp">
        ...
        <div class="Grupi" style="display: inline;">
            <select name="grupi" id="grupi" class="drp">
        ...
        <div class="ren" style="display: inline;">
            <input type="submit" value="Shikoni Orarin" id="butoni" name="kot" style="width:250px; height: 40px;">  
        </div>
