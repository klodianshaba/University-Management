      ...
      if (isset($_POST["PlotesoOraret"])) {
        ...
        $premte13 = substr($premte13,1,strlen($premte13));
          ...
          $q_premte13 = $q_premte13['Emri'];
               ...
               $value = $sql->num_rows;
               if ($value >= 1 ){
                 mysql_query("UPDATE orari SET L_id='$ejnte1',LOS='$LOSejnte1' where  Dg_id='$degaa' and Viti='$viti' and Grupi='$grupi' and dita='enjte' AND ora='1'");
...
?>
    ...
    <form action="" method="post">
        ...
        <div class="ren" style="display: inline;">
            <input type="submit" value="Vendos Orarin" id="butoni" name="kot" class="result-btn" style="width:13%;"> 
        </div><br><br>
