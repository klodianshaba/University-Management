            ...
            <ul>
                ...
                <li class="tabs"><a href="#">Notat</a> <span class="plus" id="plus6">+</span>
                    <ul class="submenu" value="none" id="sub3">
                        ...
                        <li><a href="notat/"><img src="img/sign.png" class="circle-icon-sm">Vendos Notat</a></li>
                    </ul>
                </li>
                ...
                <li class="tabs"><a href="#">Njoftime</a> <span class="plus" id="plus8">+</span>
                    <ul class="submenu" value="none" id="sub3">
                        <li><a href="shtonjoftim.php"><img src="img/sign.png" class="circle-icon-sm" id="" >Shiko Njoftimet</a></li>
                        <li><a href="shtonjoftim.php"><img src="img/sign.png" class="circle-icon-sm" id="" >Vendos Njoftimet</a></li>
                    </ul>
                </li>
            </ul>
        </div>
            ...
            <div class="photo-container">
                ...
                <!-- Modal content -->
                   <div class="modal-conten">
                       ...
                       <form action="profesor/stEditim.php" name="form" method="post" enctype="multipart/form-data">
                          <div class="ndryshofoto">
                             <h3>Zgjidhni nje foto</h3><hr>
                             <div id="errorupload"></div><br>
                               <f><label for="upload"  > Ngarko foton </label><br></f>
                               <input type="file" id="upload" name="image" style="display: none;" ><br> <br>
                               <input type="submit" name="fotoprofili" onclick="return file()" value="Ruaj Ndryshimet" style="width:100%; height: 30px;"><br><br>
                               <input type="submit" name="anullo" value="Anullo"  style="width:100%; height: 30px;">
                          </div>
                       </form>
                    </div>
    ...
    if (event.target == modal) {
        ...
        <div class="personal-details-edit" id="p-detail-edit">
            ...
            <div class="bar-container">
                ...
                <div class="color1 pdn"><?php echo $result['P_id'];?>
                    <a href="#">
                ...
                <div class="color2 row-100">Pozicioni:</div>
                    ...
                    <div class="color1 row-100">Username:</div>


                    <div class="color1 pdn"><?php echo $user;?>
                      <a href="#">
                          <div class="dropdownnnnn">
                              <button onclick="myFunctionnnnn()" disabled="disabled" class="dropbtnnn hide" >Ndrysho</button>
                              <br><br>
                    ...
                    <div class="color2 row-100">Fjalekalimi:</div>
                        <div class="color2 pdn">*************
                            <a href="#">
                        ...
                        <form name="formatit" method="post">
                            <div id="myDropdownnnnnnnnn" class="dropdown-contentnnnnnnnn edit-container end-container "><br>
                                 <label> Ndrysho Fjalekalimin *</label><br><br>
